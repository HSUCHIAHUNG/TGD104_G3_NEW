<template>
  <div class="learning_choose_content">
        ...
        <li :class="{ active: currentTab === 'tab2' }">
          <a href="#" :class="{ active: currentTab === 'tab2' }" @click.prevent="{(current = '街舞'), (currentTab = 'tab2');}">
            <div>街舞</div>
          </a>
        </li>
        <li :class="{ active: currentTab === 'tab3' }">
          <a href="#" :class="{ active: currentTab === 'tab3' }" @click.prevent="{(current = '芭蕾舞'), (currentTab = 'tab3');}">
            <div>芭蕾舞</div></a>
        </li>
        <li :class="{ active: currentTab === 'tab4' }">
          <a href="#" :class="{ active: currentTab === 'tab4' }" @click.prevent="{(current = '兒童舞蹈'), (currentTab = 'tab4');}">
            <div>兒童舞蹈</div>
          </a>
        </li>
        <li :class="{ active: currentTab === 'tab5' }">
          <a href="#" :class="{ active: currentTab === 'tab5' }" @click.prevent="{(current = '爵士舞'), (currentTab = 'tab5');}">
            <div>爵士舞</div>
          </a>
        </li>
      </ol>
  ...
  export default {
    ...
    mounted() {
      $.getJSON('http://localhost/TGD104_G3_NEW/vue-lessons/src/api/dance_Select.php').then(response => this.products = response)
