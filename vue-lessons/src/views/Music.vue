  ...
  <div class="learning_choose_content">
    ...
    <ol class="learning_second_items_tab">
        ...
        <li :class="{ active: currentTab === 'tab2' }">
          <a href="#" :class="{ active: currentTab === 'tab2' }" @click.prevent="{(current = '鋼琴'), (currentTab = 'tab2');}">
            <div>鋼琴</div>
          </a>
        </li>
        <li :class="{ active: currentTab === 'tab3' }">
          <a href="#" :class="{ active: currentTab === 'tab3' }" @click.prevent="{(current = '吉他'), (currentTab = 'tab3');}">
            <div>吉他</div></a>
        </li>
        <li :class="{ active: currentTab === 'tab4' }">
          <a href="#" :class="{ active: currentTab === 'tab4' }" @click.prevent="{(current = '烏克麗麗'), (currentTab = 'tab4');}">
            <div>烏克麗麗</div>
          </a>
        </li>
        <li :class="{ active: currentTab === 'tab5' }">
          <a href="#" :class="{ active: currentTab === 'tab5' }" @click.prevent="{(current = '爵士鼓'), (currentTab = 'tab5');}">
            <div>爵士鼓</div>
          </a>
        </li>
      </ol>
