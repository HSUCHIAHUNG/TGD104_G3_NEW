...
<!-- 
  ...
  <script>
    ...
    export default {
          ...
          products: [ 
            {
              ...
              s_title: '學烏克麗麗，輕鬆享受甜美音色！', // about_consultant
      ...
      mounted() {
        $.getJSON('http://localhost/TGD104_G3_NEW/vue-lessons/src/api/music_Select.php').then(response => this.study_cards = response)
      },
    }
  </script>
