...
<ol class="learning_second_items_tab">
        ...
        <li :class="{ active: currentTab === 'tab2' }">
          <a href="#" :class="{ active: currentTab === 'tab2' }" @click.prevent="{(current = '英文'), (currentTab = 'tab2');}">
            <div>英文</div>
          </a>
        </li>
        <li :class="{ active: currentTab === 'tab3' }">
          <a href="#" :class="{ active: currentTab === 'tab3' }" @click.prevent="{(current = '國文'), (currentTab = 'tab3');}">
            <div>國文</div></a>
        </li>
        <li :class="{ active: currentTab === 'tab4' }">
          <a href="#" :class="{ active: currentTab === 'tab4' }" @click.prevent="{(current = '化學'), (currentTab = 'tab4');}">
            <div>化學</div>
          </a>
        </li>
        <li :class="{ active: currentTab === 'tab5' }">
          <a href="#" :class="{ active: currentTab === 'tab5' }" @click.prevent="{(current = '生物'), (currentTab = 'tab5');}">
            <div>生物</div>
          </a>
        </li>
        <li :class="{ active: currentTab === 'tab6' }">
          <a href="#" :class="{ active: currentTab === 'tab6' }" @click.prevent="{(current = '微積分'), (currentTab = 'tab6');}">
            <div>微積分</div>
          </a>
        </li>
      </ol>
