...
export default {
  ...
  methods: {
    removeFav(id) {
      ...
      // 更新會員收藏清單
      $.ajax({
        url: "http://localhost/TGD_104_G3/vue-lessons/src/api/removeFav.php",
        dataType: "text",
        type: "POST",
        data: {
          id: member_id,
  ...
  mounted() {
    ...
    if (Member_id) {
      $.ajax({
        url: "http://localhost/TGD_104_G3/vue-lessons/src/api/memberfav.php",
        dataType: "json",
        type: "POST",
        data: {
          id: Member_id,
        ...
        success: (response) => {
          ...
          if (this.favList == null) {
            ...
            $.ajax({
              url: "http://localhost/TGD_104_G3/vue-lessons/src/api/memberfavS.php",
              dataType: "json",
              type: "POST",
              data: {
                id: Member_id,
