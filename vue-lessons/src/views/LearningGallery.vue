<template>
  ...
  <div class="top_detail_introduce">
        ...
        <div class="detail_introduce learning_detail" v-for="(learning_detail, index) in Learning_consultantDetail" :key="index">
    ...
    <router-link to="/learningchoose/music"><button class="btn_orange">回預約頁面</button></router-link>
    </div>
