    ...
    finalRound($event) {
      ...
      if (!this.once) {
        ...
        pick3.innerHTML = `<img src="${
          ...
          this.finalPick
        }" /><div class='final-picked'><p class="final">恭喜您選出專屬您的理想顧問!</p><a class="more">查看更多</a></div>`;
        pick3.querySelector(".more").addEventListener("click", this.toCard);
      }
    },
    toCard() {
      this.$router.push("/travelgallery");
    },
  },
  mounted() {
    // 按題目分別塞入對應的照片
