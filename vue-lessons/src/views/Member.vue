...
export default {
  ...
  methods: {
    ...
    save() {
      $.ajax({
        url: "http://localhost/TGD_104_G3/vue-lessons/src/api/memberUpdate.php",
        dataType: "text",
        type: "POST",
        data: {
    ...
    changePwd() {
      ...
      if (this.pwd.new !== this.pwd.check_new) {
        ...
        $.ajax({
          url: "http://localhost/TGD_104_G3/vue-lessons/src/api/changePwd.php",
          dataType: "text",
          type: "POST",
          data: {
            id: id,
  ...
  mounted() {
    ...
    if (!Member_id) {
      ...
      $.ajax({
        url: "http://localhost/TGD_104_G3/vue-lessons/src/api/memberInfo.php",
        dataType: "json",
        type: "POST",
        data: {
          id: Member_id,
