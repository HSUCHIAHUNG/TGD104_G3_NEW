  ...
  <section class="about_story2">
    <div class="about_story2_container container">
      <div class="about_story2_left">
        <h1 class="content_h1">
          身為一個擁有豐富閱歷經驗的大叔想做些事情來重拾社會對大叔的正面形象決定，<span
            class="content_span"
            >出租自己</span
          >以展現大叔被遺忘的魅力 。
        </h1>
