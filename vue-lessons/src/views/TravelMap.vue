    ...
    <main class="travel_map_wrapper">
        <div class="container">
            <div class="travel_map">
                ...
                <!-- 鯊魚 -->
                <svg id="shark" version="1.1" xmlns="../assets/image/travel/shark.svg" x="0px" y="0px" width="280px" height="150px" viewBox="0 0 434.5 230.2" style="enable-background:new 0 0 434.5 230.2;" xml:space="preserve">
                  ...
                  <g id="shark">
                    ...
                    <g id="transform" class="st0">
                      <g class="shark-reverse">
                        <g class="shark-rotate">
                          <g class="sharkback">
        ...
        <!-- 搖晃船 -->
        <svg id="sea" viewBox="0 0 127 199" version="1.1" xmlns="../assets/image/travel/boat.svg"> 
            <defs>
